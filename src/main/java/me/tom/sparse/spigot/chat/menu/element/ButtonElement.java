...
public class ButtonElement extends Element
{
	 ...
	 */
	public ButtonElement(int x, int y, @NotNull String text, @NotNull Consumer<Player> callback)
	{
	 ...
	 */
	public ButtonElement(int x, int y, @NotNull String text, @NotNull Function<Player, Boolean> callback)
	{
		super(x, y);
		if(text.contains("\n"))
